<template>
  <section class="container">
    ...
    <div class="features-grid">
      ...
      <div class="feature-card" @click="showSection('component')">
        <div class="feature-icon">🧩</div>
        <h3>Componenti</h3>
        <p>Creazione dell'interfaccia con JSX.</p>
      </div>

      <div class="feature-card" @click="showSection('styles')">
        <div class="feature-icon">🎨</div>
        <h3>Stili</h3>
        <p>Layout Flexbox e StyleSheet.</p>
      </div>

      <div class="feature-card" @click="showSection('sintax')">
        <div class="feature-icon">📘</div>
        <h3>Sintassi di Base</h3>
        <p>Componenti fondamentali e hook.</p>
      </div>

      <div class="feature-card" @click="showSection('debug')">
        <div class="feature-icon">🛠️</div>
        <h3>Debug e strumenti</h3>
        <p>Durante lo sviluppo, React Native offre diversi strumenti.</p>
      </div>

      <div class="feature-card" @click="showSection('examples')">
        <div class="feature-icon">💡</div>
...
<span class="keyword">const</span> styles = <span class="component">StyleSheet</span>.<span class="function">create</span>({
  ...
  item: {
    ...
    <div v-show="activeSection === 'styles'" class="api-section">
  ...
  button: {
    ...
    <div v-show="activeSection === 'debug'" class="api-section">
      ...
      <p>
        ...
        ottimizzare le prestazioni e garantire la corretta esecuzione del codice. React Native mette a disposizione 
        una serie di strumenti integrati e professionali che semplificano enormemente questo processo.
      </p>
    ...
    <div v-show="activeSection === 'examples'" class="api-section">
...
<span class="keyword">const</span> styles = <span class="component">StyleSheet</span>.<span class="function">create</span>({
  ...
  buttons: {
    ...
    <div v-show="activeSection === 'sintax'" class="api-section">
      ...
      <div class="syntax-grid">
        <div class="syntax-item">
          <h3>🎣 useState</h3>
          <p>Hook per la gestione dello stato locale del componente. Permette di creare variabili reattive che, quando modificate, causano il re-rendering del componente.</p>
        ...
        <div class="syntax-item">
          <h3>📦 View</h3>
          <p>Contenitore principale per il layout. Equivalente al <code>div</code> in HTML. Supporta stili, eventi touch e layout flexbox.</p>
          <div class="code-example">
        ...
        <div class="syntax-item">
          <h3>📝 Text</h3>
          <p>Componente per visualizzare testo. A differenza del web, tutto il testo deve essere racchiuso in un componente Text.</p>
          <div class="code-example">
        ...
        <div class="syntax-item">
          <h3>🔘 Button</h3>
          <p>Pulsante nativo con gestione eventi. Utilizza l'evento <code>onPress</code> invece di <code>onClick</code>.</p>
          <div class="code-example">
        ...
        <div class="syntax-item">
          <h3>⌨️ TextInput</h3>
          <p>Campo di input per inserimento testi. Gestisce la digitazione dell'utente tramite <code>onChangeText</code>.</p>
          <div class="code-example">
        ...
        <div class="syntax-item">
          <h3>📋 FlatList</h3>
          <p>Componente ottimizzato per renderizzare liste lunghe. Carica solo gli elementi visibili per migliorare le performance.</p>
          <div class="code-example">
        ...
        <div class="syntax-item">
          ...
          <p>Metodo per definire stili in modo ottimizzato. Gli stili vengono validati e ottimizzati in fase di creazione.</p>
          <div class="code-example">
        ...
        <div class="syntax-item">
          <h3>🖼️ Image</h3>
          <p>Componente per visualizzare immagini da diverse sorgenti (locale, remota, base64).</p>
          <div class="code-example">
            <code>&lt;Image source=&#123;&#123;uri: 'url'&#125;&#125; style=&#123;...&#125; /&gt;</code>
          </div>
        </div>
      </div>
      
      <div class="info-box">
        <strong>📚 Documentazione:</strong> Per approfondire ogni componente e API, consulta la 
...
.api-section h3.subsection-title {
  margin-top: 40px;
  margin-bottom: 15px;
  font-size: 24px;
  color: #c792ea;
...
.syntax-item:hover {
  ...
  box-shadow: 0 10px 30px rgba(199, 146, 234, 0.15);
}
